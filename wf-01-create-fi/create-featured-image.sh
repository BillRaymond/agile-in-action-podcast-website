...
echo “* START Career Progression: Working above the waterline”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/luke-pivac.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Career Progression: Working above the waterline' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Luke Pivac\nLuke Pivac, Delivery Lead at Westpac and author of An Agile Playbook for Technical Communicators' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-01-23-career-progression-working-above-the-waterline-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-01-23-career-progression-working-above-the-waterline.png

echo “* FINISH Career Progression: Working above the waterline”

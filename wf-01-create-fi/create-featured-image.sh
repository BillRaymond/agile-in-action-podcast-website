...
echo “* START Learn Agile and Scrum in Two Hours”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/luke-pivac-2025.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Learn Agile and Scrum in Two Hours' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Luke Pivac\nCo-author, Learn Agile and Scrum in 2 Hours' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2025-06-03-luke-pivac-scrum-book-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2025-06-03-luke-pivac-scrum-book.png

echo “* FINISH Learn Agile and Scrum in Two Hours”

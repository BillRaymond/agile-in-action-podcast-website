...
-size 580x340 caption:'Bridging AI data science and engineering: A personal journey' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Christos Hadjinikolis\nMachine Learning Engineer at Vortexa' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2023-10-31-bridging-ai-data-science-and-engineering-a-personal-journey-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2023-10-31-bridging-ai-data-science-and-engineering-a-personal-journey.png

echo “* FINISH Bridging AI data science and engineering: A personal journey”

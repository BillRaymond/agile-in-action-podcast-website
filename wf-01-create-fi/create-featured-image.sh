...
\( ../uploads/wf-guest-images-fi/David-Abodunrin.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
+write ../uploads/wf-featured-images/2023-11-14-charting-a-new-course-transitioning-to-agile-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2023-11-14-charting-a-new-course-transitioning-to-agile.png

...
echo “* START AI in Learning Design”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/bhavneet-chahal.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'AI in Learning Design' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Bhavneet Chahal\nCo-founder and CEO at GoSkills' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2025-07-15-ai-in-learning-design-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2025-07-15-ai-in-learning-design.png

echo “* FINISH AI in Learning Design”

...
echo “* START Truth over artificial harmony”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/james-murphy.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Truth over artificial harmony' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with James "Murph" Murphy\nFounder of Afterburner and Managing Partner at Afterburner Capital' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-02-13-truth-over-artificial-harmony-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-02-13-truth-over-artificial-harmony.png

echo “* FINISH Truth over artificial harmony”

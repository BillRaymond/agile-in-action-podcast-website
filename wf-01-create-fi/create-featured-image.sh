...
echo “* START Living with complexity and exploring the Cynefin framework”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/douglas-squirrel-june-2024-v2.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Living with complexity and exploring the Cynefin framework' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Douglas Squirrel\nAuthor of Agile Conversations' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-06-25-living-with-complexity-and-exploring-the-cynefin-framework-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-06-25-living-with-complexity-and-exploring-the-cynefin-framework.png

echo “* FINISH Living with complexity and exploring the Cynefin framework”

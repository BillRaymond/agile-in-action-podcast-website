...
echo “* START AI Agents in Action: Making Teams Leaner and Faster”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/bill-ryan.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'AI Agents in Action: Making Teams Leaner and Faster' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Bill Ryan\nFounder and Partner at Velocity Advisors' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2025-10-21-ai-agents-in-action-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2025-10-21-ai-agents-in-action.png

echo “* FINISH AI Agents in Action: Making Teams Leaner and Faster”

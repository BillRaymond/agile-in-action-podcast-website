...
echo “* START Creating great internship programs”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/robert-j-khoury-3.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Creating great internship programs' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Robert J. Khoury\nAuthor of Intern Management: Principles for Designing an Exceptional Internship' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-01-09-creating-great-internship-programs-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-01-09-creating-great-internship-programs.png

echo “* FINISH Creating great internship programs”

...
echo “* START Can Agile Transform Non-Software Teams Too?”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/gil-broza.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Can Agile Transform Non-Software Teams Too?' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Gil Broza\nDelivery &amp; Agile Leadership Expert and Author of Agile for Non-Software Teams' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-04-16-can-agile-transform-non-software-teams-too-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-04-16-can-agile-transform-non-software-teams-too.png

echo “* FINISH Can Agile Transform Non-Software Teams Too?”

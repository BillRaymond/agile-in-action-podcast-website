...
echo “* START Scaling AI Product Teams”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/Paolo-Sammicheli.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Scaling AI Product Teams' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Paolo Sammicheli\nAuthor Scrum in AI: Artificial Intelligence Agile Development with Scrum' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-04-30-scaling-ai-product-teams-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-04-30-scaling-ai-product-teams.png

echo “* FINISH Scaling AI Product Teams”

...
echo “* START Acknowledging Change and the Case for Project Professionals”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/adam-boddison-headshot.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Acknowledging Change and the Case for Project Professionals' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Professor Adam Boddison\nCEO, Association for Project Management' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2025-05-20-acknowledging-change-and-acting-the-case-for-project-professionals-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2025-05-20-acknowledging-change-and-acting-the-case-for-project-professionals.png

echo “* FINISH Acknowledging Change and the Case for Project Professionals”

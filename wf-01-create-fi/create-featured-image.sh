...
echo “* START Objective-driven Agility”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/allan-kelly-photo.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Objective-driven Agility' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Allan Kelly\nAuthor of Succeeding with OKRs in Agile (2nd edition)' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-07-23-objective-driven-agility-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-07-23-objective-driven-agility.png

echo “* FINISH Objective-driven Agility”

...
echo “* START Human-centered AI automations”
...
-size 580x340 caption:'Human-centered AI automations' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Bill Ryan\nCo-founder, Sync(d) AI' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2026-01-27-human-centered-ai-automations-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2026-01-27-human-centered-ai-automations.png

echo “* FINISH Human-centered AI automations”

...
echo “* START In retrospect, this [Scrum] event should have been fun”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/paulo-caroli.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'In retrospect, this [Scrum] event should have been fun' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Paulo Caroli\nSpeaker, Author, and Advisor at Thoughtworks' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-02-27-in-retrospect,-this-[scrum]-event-should-have-been-fun-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-02-27-in-retrospect,-this-[scrum]-event-should-have-been-fun.png

echo “* FINISH In retrospect, this [Scrum] event should have been fun”

...
echo “* START Learning and Leading in a digital-first world”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/Sophia-Matveeva.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Learning and Leading in a digital-first world' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Sophia Matveeva\nCEO &amp; Founder, Tech for Non-Techies' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-01-30-learning-and-leading-in-a-digital-first-world-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-01-30-learning-and-leading-in-a-digital-first-world.png

echo “* FINISH Learning and Leading in a digital-first world”

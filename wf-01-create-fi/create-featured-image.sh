...
echo “* START Charting a New Course: Transitioning to Agile”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/David-Adeoye-Abodunrin.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'Charting a New Course: Transitioning to Agile' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with David Abodunrin\nAgile Coach and SCRUM Master' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2023-11-15-charting-a-new-course-transitioning-to-agile-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2023-11-15-charting-a-new-course-transitioning-to-agile.png

echo “* FINISH Charting a New Course: Transitioning to Agile”

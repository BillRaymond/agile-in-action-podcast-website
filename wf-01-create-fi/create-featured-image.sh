...
echo “* START Becoming a Great Un-manager”
...
-size 580x340 caption:'Becoming a Great Un-manager' `# Podcast title as it appears on the website`\
...
+write ../uploads/wf-featured-images/2023-12-12-becoming-a-great-un-manager-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2023-12-12-becoming-a-great-un-manager.png

echo “* FINISH Becoming a Great Un-manager”

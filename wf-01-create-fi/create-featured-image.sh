...
echo “* START Becoming a Great Manger”
...
-size 580x340 caption:'Becoming a Great Manger' `# Podcast title as it appears on the website`\
...
+write ../uploads/wf-featured-images/2023-12-12-becoming-a-great-manger-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2023-12-12-becoming-a-great-manger.png

echo “* FINISH Becoming a Great Manger”

...
echo “* START AI and Agile in Federally Regulated Robotics Prototyping”
convert fi-template.png `# load template background image`\
\( ../uploads/wf-guest-images-fi/captain-jon-haase.png -resize 282x282 -set page +256+205 \) `# load a guest photo`\
...
-size 580x340 caption:'AI and Agile in Federally Regulated Robotics Prototyping' `# Podcast title as it appears on the website`\
...
-size 405x195 caption:'with Captain Jonathan Haase\nProgram Manager, US Navy Expeditionary Missions Program Office (PMS 408) at NAVSEA' `# List the guest names for the podcast`\
-geometry +550+446 `# Set the x and y position of the guest names`\
-composite `# Add guest names to the image`\
+write ../uploads/wf-featured-images/2024-09-17-ai-and-agile-robotics-in-federally-regulated-environments-no-play.png \
-page +972+448 fi-play-icon-youtube.png `# load YouTube icon image`\
-layers flatten \
../uploads/wf-featured-images/2024-09-17-ai-and-agile-robotics-in-federally-regulated-environments.png

echo “* FINISH AI and Agile in Federally Regulated Robotics Prototyping”

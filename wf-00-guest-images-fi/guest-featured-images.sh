...
set -e -x
echo “photoSource: ../uploads/bhavneet-chahal.jpeg”

echo “Original photoTarget: ../uploads/bhavneet-chahal.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/bhavneet-chahal.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 46”
echo “photoSource: ../uploads/bhavneet-chahal.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/bhavneet-chahal.png”
echo “* START Converting guest photo: ../uploads/bhavneet-chahal.jpeg”
convert ../uploads/bhavneet-chahal.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/bhavneet-chahal.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/bhavneet-chahal.png”
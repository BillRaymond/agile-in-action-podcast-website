...
set -e -x
echo “photoSource: ../uploads/gil-broza.jpg”

echo “Original photoTarget: ../uploads/gil-broza.jpg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/gil-broza.jpg”
echo “photoTargetExt: jpg”
echo “photoTargetExtSize: 40”
echo “photoSource: ../uploads/gil-broza.jpg”

echo “photoTarget: ../uploads/wf-guest-images-fi/gil-broza.png”
echo “* START Converting guest photo: ../uploads/gil-broza.jpg”
convert ../uploads/gil-broza.jpg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/gil-broza.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/gil-broza.png”
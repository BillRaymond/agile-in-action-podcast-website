...
set -e -x
echo “photoSource: ../uploads/captain-jon-haase.jpeg”

echo “Original photoTarget: ../uploads/captain-jon-haase.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/captain-jon-haase.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 48”
echo “photoSource: ../uploads/captain-jon-haase.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/captain-jon-haase.png”
echo “* START Converting guest photo: ../uploads/captain-jon-haase.jpeg”
convert ../uploads/captain-jon-haase.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/captain-jon-haase.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/captain-jon-haase.png”
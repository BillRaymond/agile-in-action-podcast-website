...
set -e -x
echo “photoSource: ../uploads/jack-skeels.jpeg”

echo “Original photoTarget: ../uploads/jack-skeels.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/jack-skeels.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 42”
echo “photoSource: ../uploads/jack-skeels.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/jack-skeels.png”
echo “* START Converting guest photo: ../uploads/jack-skeels.jpeg”
convert ../uploads/jack-skeels.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/jack-skeels.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/jack-skeels.png”
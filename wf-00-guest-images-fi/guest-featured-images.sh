...
set -e -x
echo “photoSource: ../uploads/luke-pivac.jpeg”

echo “Original photoTarget: ../uploads/luke-pivac.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/luke-pivac.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 41”
echo “photoSource: ../uploads/luke-pivac.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/luke-pivac.png”
echo “* START Converting guest photo: ../uploads/luke-pivac.jpeg”
convert ../uploads/luke-pivac.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/luke-pivac.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/luke-pivac.png”
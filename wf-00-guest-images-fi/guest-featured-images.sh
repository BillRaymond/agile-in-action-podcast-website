...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/angela-johnson.png”echo “* START Converting guest photo: uploads/seaasons-of-scrum-winter.png”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/seaasons-of-scrum-winter.png”echo “* START Converting guest photo: uploads/marsha-acker.png”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/marsha-acker.png”echo “* START Converting guest photo: uploads/build-your-model-for-leading-change.png”
convert uploads/build-your-model-for-leading-change.png `# load the guest’s photo`\
    -resize 250x250^ `# load template background image`\
    -gravity center `# Set the center of gravity for the photo`\
    -background transparent `# Background should be transparent`\
    -extent 250x250 `# Crop the photo to a perfect square`\
    ...
    \( +clone -background black -shadow 60x5+6+6 \) `# Create a shadow under the photo`\
    +swap -background none -layers merge +repage `# Merge the photo and shadow layers`\
    uploads/wf-guest-images-fi/build-your-model-for-leading-change.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/build-your-model-for-leading-change.png”echo “* START Converting guest photo: uploads/kathleen-walch.jpeg”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/ronald-schmelzer.png”echo “* START Converting guest photo: uploads/new-ai-today-podcast-image.png”
convert uploads/new-ai-today-podcast-image.png `# load the guest’s photo`\
    -resize 250x250^ `# load template background image`\
    -gravity center `# Set the center of gravity for the photo`\
    -background transparent `# Background should be transparent`\
    -extent 250x250 `# Crop the photo to a perfect square`\
    ...
    \( +clone -background black -shadow 60x5+6+6 \) `# Create a shadow under the photo`\
    +swap -background none -layers merge +repage `# Merge the photo and shadow layers`\
    uploads/wf-guest-images-fi/new-ai-today-podcast-image.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/new-ai-today-podcast-image.png”
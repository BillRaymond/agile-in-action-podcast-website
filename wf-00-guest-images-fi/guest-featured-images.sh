...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/angela-johnson.png”echo “* START Converting guest photo: uploads/new-ai-today-podcast-image.png”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/new-ai-today-podcast-image.png”echo “* START Converting guest photo: uploads/kathleen-walch.jpeg”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/ronald-schmelzer.png”
...
set -e -x
echo “photoSource: ../uploads/allan-kelly-photo.png”

echo “Original photoTarget: ../uploads/allan-kelly-photo.png”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/allan-kelly-photo.png”
echo “photoTargetExt: png”
echo “photoTargetExtSize: 48”
echo “photoSource: ../uploads/allan-kelly-photo.png”

echo “photoTarget: ../uploads/wf-guest-images-fi/allan-kelly-photo.png”
echo “* START Converting guest photo: ../uploads/allan-kelly-photo.png”
convert ../uploads/allan-kelly-photo.png `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/allan-kelly-photo.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/allan-kelly-photo.png”
...
set -e -x
echo “photoSource: ../uploads/robert-j-khoury-3.png”

echo “Original photoTarget: ../uploads/robert-j-khoury-3.png”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/robert-j-khoury-3.png”
echo “photoTargetExt: png”
echo “photoTargetExtSize: 48”
echo “photoSource: ../uploads/robert-j-khoury-3.png”

echo “photoTarget: ../uploads/wf-guest-images-fi/robert-j-khoury-3.png”
echo “* START Converting guest photo: ../uploads/robert-j-khoury-3.png”
convert ../uploads/robert-j-khoury-3.png `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/robert-j-khoury-3.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/robert-j-khoury-3.png”
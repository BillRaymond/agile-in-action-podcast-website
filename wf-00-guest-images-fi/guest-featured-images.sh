...
set -e -x
echo “photoSource: ../uploads/luke-pivac-2025.jpeg”

echo “Original photoTarget: ../uploads/luke-pivac-2025.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/luke-pivac-2025.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 46”
echo “photoSource: ../uploads/luke-pivac-2025.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/luke-pivac-2025.png”
echo “* START Converting guest photo: ../uploads/luke-pivac-2025.jpeg”
convert ../uploads/luke-pivac-2025.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/luke-pivac-2025.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/luke-pivac-2025.png”
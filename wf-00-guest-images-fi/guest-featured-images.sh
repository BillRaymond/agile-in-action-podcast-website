...
set -e -x
echo “photoSource: ../uploads/bill-ryan.jpeg”

echo “Original photoTarget: ../uploads/bill-ryan.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/bill-ryan.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 40”
echo “photoSource: ../uploads/bill-ryan.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/bill-ryan.png”
echo “* START Converting guest photo: ../uploads/bill-ryan.jpeg”
convert ../uploads/bill-ryan.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/bill-ryan.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/bill-ryan.png”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/Maximilian-Kupi.png”echo “* START Converting guest photo: uploads/Keegan-McBride.jpeg”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/Keegan-McBride.png”echo “* START Converting guest photo: uploads/dave-witkin.jpeg”

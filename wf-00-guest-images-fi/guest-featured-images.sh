...
echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/peter-stevens.png”echo “photoSource: ../uploads/zorina-alliata.jpeg”

echo “Original photoTarget: ../uploads/zorina-alliata.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/zorina-alliata.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 45”
echo “photoSource: ../uploads/zorina-alliata.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/zorina-alliata.png”
echo “* START Converting guest photo: ../uploads/zorina-alliata.jpeg”
convert ../uploads/zorina-alliata.jpeg `# load the guest’s photo`\
    -resize 250x250^ `# load template background image`\
    -gravity center `# Set the center of gravity for the photo`\
    -background transparent `# Background should be transparent`\
    -extent 250x250 `# Crop the photo to a perfect square`\
...
echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/zorina-alliata.png”echo “photoSource: ../uploads/Maximilian-Kupi.jpeg”
...
echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/Keegan-McBride.png”
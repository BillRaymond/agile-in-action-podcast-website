...
set -e -x
echo “photoSource: ../uploads/james-murphy.jpeg”

echo “Original photoTarget: ../uploads/james-murphy.jpeg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/james-murphy.jpeg”
echo “photoTargetExt: jpeg”
echo “photoTargetExtSize: 43”
echo “photoSource: ../uploads/james-murphy.jpeg”

echo “photoTarget: ../uploads/wf-guest-images-fi/james-murphy.png”
echo “* START Converting guest photo: ../uploads/james-murphy.jpeg”
convert ../uploads/james-murphy.jpeg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/james-murphy.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/james-murphy.png”
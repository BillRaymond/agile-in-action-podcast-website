...
set -e -x
echo “* START Converting guest photo: uploads/idzik_img.png”
...
echo “* FINISH converted guest photo to: uploads/wf-guest-images-fi/idzik_img.png”echo “* START Converting guest photo: uploads/nader-k-rad.jpeg”

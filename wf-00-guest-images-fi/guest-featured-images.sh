...
set -e -x
echo “photoSource: ../uploads/paulo-caroli.jpg”

echo “Original photoTarget: ../uploads/paulo-caroli.jpg”

echo “photoTarget with new url: ../uploads/wf-guest-images-fi/paulo-caroli.jpg”
echo “photoTargetExt: jpg”
echo “photoTargetExtSize: 43”
echo “photoSource: ../uploads/paulo-caroli.jpg”

echo “photoTarget: ../uploads/wf-guest-images-fi/paulo-caroli.png”
echo “* START Converting guest photo: ../uploads/paulo-caroli.jpg”
convert ../uploads/paulo-caroli.jpg `# load the guest’s photo`\
    ...
    ../uploads/wf-guest-images-fi/paulo-caroli.png `# Save the guest photo`\

echo “* FINISH converted guest photo to: ../uploads/wf-guest-images-fi/paulo-caroli.png”